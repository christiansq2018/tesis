        ...
        <table class="table table-bordered table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                @if( $user->imagen )
                <img src="{{ asset('storage/img/usuario/' . $user->imagen ) }}" id="imagen1" alt="{{$user->nombre}}"
                  class="img-responsive" width="100px" height="100px">
                @else
                <img src="{{ asset('img/avatars/7.jpg' ) }}" id="imagen1" alt="{{$user->nombre}}" class="img-responsive"
              ...
              <td>
                <button type="button" class="btn btn-info btn-md" data-id_usuario="{{$user->id}}"
                  ...
                  data-telefono="{{$user->telefono}}" data-email="{{$user->email}}" data-id_rol="{{$user->role_id}}"
                  data-usuario="{{$user->usuario}}" data-imagen1="{{$user->imagen}}" data-toggle="modal"
              ...
              <td>
                ...
                <button type="button" class="btn btn-danger btn-sm" data-id_usuario="{{$user->id}}" data-toggle="modal"
                ...
                <button type="button" class="btn btn-success btn-sm" data-id_usuario="{{$user->id}}" data-toggle="modal"
                  data-target="#cambiarEstado">
