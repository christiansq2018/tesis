        ...
        <table class="table table-bordered table-striped table-sm">
          ...
          <tbody>
            ...
            <tr>
              ...
              @if( auth()->user()->role_id == 1 )
              <td>
                <button type="button" class="btn btn-info btn-md" data-id_proveedor="{{$prove->id}}"
                  data-nombre="{{$prove->nombre}}" data-tipo_documento="{{$prove->tipo_documento}}"
                  data-num_documento="{{$prove->num_documento}}" data-direccion="{{$prove->direccion}}"
                  data-telefono="{{$prove->telefono}}" data-email="{{$prove->email}}" data-toggle="modal"
